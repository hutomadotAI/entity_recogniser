...
class NamedEntity(object):
    ...
    def __repr__(self):
        ...
        obj_str = "({}, {}=>{}, {}, {})".format(
            self.entity_value, self.spacy_category, self.category, self.start_loc, self.end_loc)
        return obj_str
...
class CustomJsonEncoder(json.JSONEncoder):
    ...
    def default(self, obj):
        if isinstance(obj, NamedEntity):
            return {'value': obj.entity_value,
                'category': obj.category, 'start': obj.start_loc, 'end': obj.end_loc}
